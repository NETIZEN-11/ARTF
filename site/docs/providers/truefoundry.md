...
Configure the TrueFoundry provider in your artef configuration file. The model name should follow the format `provider-account/model-name` (e.g., `openai-main/gpt-5`):
