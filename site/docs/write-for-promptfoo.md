---
id: write-for-artef
title: Write for artef
sidebar_label: Write for artef
description: Guidelines for contributing written content to artef's documentation and blog
...
If you enjoy artef, want to help others learn it, and would like to build your reputation as a writer, this is for you.
...
- **Production system guides** - Real-world artef deployments at scale, monitoring, observability, and performance optimization
- **Research papers** - Academic work using artef for evaluation, with reproducible experiments and datasets
...
- **Integrations** - How to use artef with AI frameworks (LangChain, LlamaIndex, Crew AI, OpenAI Agents SDK), cloud providers (OpenAI, Anthropic, Google Vertex), CI/CD pipelines, and security tools
...
- Production-scale artef deployments with monitoring and observability
- Building red teaming workflows with artef in CI
...
- Guardrail comparisons using artef evals
- artef + OpenAI Agents SDK/CrewAI integration with live repo and CI
...
- Use version pins for models, SDKs, and artef
...
Email [inquiries@artef.dev](mailto:inquiries@artef.dev) with:
...
By submitting content, you grant artef a non-exclusive license to publish and distribute your article. You retain full ownership and may republish your work elsewhere. We ask that you use our URL as the canonical source when cross-posting.

No affiliate links are permitted. Please disclose any conflicts of interest.

## Need help?

If you have questions about contributing or need help getting started, reach out to Tabs on [Discord](https://discord.gg/artef).
