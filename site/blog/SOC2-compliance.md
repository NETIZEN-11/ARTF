---
title: 'artef Achieves SOC 2 Type II and ISO 27001 Certification: Strengthening Trust in AI Security'
description: 'artef achieves SOC 2 Type II and ISO 27001 compliance, demonstrating enterprise-grade security for AI red teaming and LLM evaluation tools.'
...
# artef Achieves SOC 2 Type II and ISO 27001 Certification: Strengthening Trust in AI Security

We're proud to announce that artef is now SOC 2 Type II compliant and ISO 27001 certified — two globally recognized milestones that affirm our commitment to the highest standards in information security, privacy, and risk management.

At artef, we help organizations secure their generative AI applications by proactively identifying and fixing vulnerabilities through adversarial emulation and red teaming. These new certifications reflect our continued investment in building secure, trustworthy AI systems — not only in our technology, but across our entire organization.
...
Together, these certifications demonstrate that artef meets the security and compliance expectations of modern enterprises — from regulated industries to forward-thinking AI adopters.
...
- artef operates with a mature, resilient, and continually improving security program
...
To learn more about our security practices or request our audit reports, visit our [Trust Center](https://trust.artef.dev/) or contact us at security@artef.com.
