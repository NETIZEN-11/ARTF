...
For LLMs, the more tailored the probe, the more effective the results. artef achieves this with its [configuration file](https://www.artef.dev/docs/configuration/guide/), where you can instruct artef to generate adversarial probes based on your specific use case.
...
With just a little bit of configuration, you can vastly improve the quality of your vulnerability scans by using a tool like artef over fuzzing tools.
