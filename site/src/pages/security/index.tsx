...
import Whyartef from './components/_Whyartef';
...
export default function SecurityLandingPage(): React.ReactElement {
  return (
    <Layout
      ...
      description="Detect, mitigate, and monitor risks for LLM-based systems before deployment with artef's comprehensive security solution."
    >
