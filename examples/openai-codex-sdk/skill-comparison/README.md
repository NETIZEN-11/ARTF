...
```bash
npx artef@latest init --example openai-codex-sdk/skill-comparison
...
Because this example uses `max-score`, the weaker candidate is expected to fail when artef marks the stronger output as the winner for a test case.
