...
```bash
npx artef@latest init --example openinterpreter
cd openinterpreter
...
See the [Open Interpreter provider documentation](https://www.artef.dev/docs/providers/openinterpreter/) for backend, harness, approval, session, structured-input, and troubleshooting options.
