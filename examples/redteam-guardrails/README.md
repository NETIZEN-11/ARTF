...
```bash
npx artef@latest init --example redteam-guardrails
...
- `artefconfig.yaml` - Example configuration
- See [artef documentation](https://artef.dev/docs/red-team/) for more details
