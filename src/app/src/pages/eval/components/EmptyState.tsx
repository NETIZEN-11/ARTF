    ...
    <div className="flex justify-center items-center min-h-[50vh]">
      <Card className="p-8 text-center max-w-[500px] shadow-lg">
        <div className="flex flex-row gap-2 items-center justify-center mb-4">
          <img src={logo} alt="artef logo" style={{ width: 48, height: 48 }} />
          <h2 className="text-xl font-semibold">Welcome to artef</h2>
        </div>
        ...
        <p className="text-sm text-muted-foreground mt-6">
          Or run <code className="bg-muted px-1 rounded">artef init</code> from the command line
        </p>
        <div className="mt-4">
          <a
