...
const frameworkInfo: Record<string, { name: string; description: string; pip: string }> = {
  ...
  'generic-agent': {
    name: 'Other Agent',
    description:
      'Any agent framework - artef is fully customizable and supports all agent frameworks',
        ...
        <AlertContent>
          <AlertDescription>
            ...
            {agentType === 'generic-agent' ? (
              <p className="italic">
                <strong>Tip:</strong> artef works with ANY Python-based agent framework. Simply
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="mb-4 max-w-[1000px] text-muted-foreground">
            Want to see how it works? artef can generate a starter template for{' '}
