...
const rawRedteamProviderFactories: ProviderFactory[] = [
  ...
  {
    test: (providerPath: string) => providerPath === 'artef:redteam:best-of-n',
    create: async (_providerPath, providerOptions) => {
  ...
  {
    test: (providerPath: string) => providerPath === 'artef:redteam:crescendo',
    create: async (_providerPath, providerOptions) => {
  ...
  {
    test: (providerPath: string) => providerPath === 'artef:redteam:goat',
    create: async (_providerPath, providerOptions) => {
  ...
  {
    test: (providerPath: string) => providerPath === 'artef:redteam:mischievous-user',
    create: async (_providerPath, providerOptions) => {
  ...
  {
    test: (providerPath: string) => providerPath === 'artef:redteam:iterative',
    create: async (_providerPath, providerOptions) => {
  ...
  {
    test: (providerPath: string) => providerPath === 'artef:redteam:iterative:image',
    create: async (_providerPath, providerOptions) => {
  ...
  {
    test: (providerPath: string) => providerPath === 'artef:redteam:iterative:tree',
    create: async (_providerPath, providerOptions) => {
  ...
  {
    test: (providerPath: string) => providerPath === 'artef:redteam:iterative:meta',
    create: async (_providerPath, providerOptions) => {
  ...
  {
    test: (providerPath: string) => providerPath === 'artef:redteam:hydra',
    create: async (_providerPath, providerOptions) => {
  ...
  {
    test: (providerPath: string) => providerPath === 'artef:redteam:goblin',
    create: async (_providerPath, providerOptions) => {
  ...
  {
    test: (providerPath: string) => providerPath === 'artef:redteam:indirect-web-pwn',
    create: async (_providerPath, providerOptions) => {
