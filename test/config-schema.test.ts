...
describe('config-schema.json', () => {
  ...
  it('should have required top-level properties', () => {
    ...
    expect(schema.definitions).toHaveProperty('artefConfigSchema');
  });
  ...
  describe('schema structure', () => {
    it('should define UnifiedConfig properly', () => {
      const unifiedConfig = schema.definitions?.artefConfigSchema;
    ...
    it('should have redteam configuration', () => {
      const properties = schema.definitions?.artefConfigSchema?.properties;
  ...
  describe('generated schema integrity', () => {
    it('should match the structure generated by zod-to-json-schema', () => {
      ...
      expect(schema.$ref).toBe('#/definitions/artefConfigSchema');
      expect(schema.definitions).toBeDefined();

      // Check that the main schema definition exists
      const mainDef = schema.definitions.artefConfigSchema;
